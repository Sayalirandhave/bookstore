...
<body>
    ...
    <div class=" book-info mx-4 lg:h-screen lg:overflow-y-scroll lg:w-full scrollbar-hidden">
       ...
       <div class="search-container py-4 flex items-center justify-between">
        ...
        <div class="cart-count hidden md:block">
            <?php ShoppingCart(); ?>
        </div>
    </div>
        ...
        <div class="flex flex-col p-4 mb-4 shadow bg-white rounded lg:flex-row lg:gap-4">
            ...
            if(isset($_GET['id']))
            {
                ...
                echo '
                <img data-id="'.$id.'" class="book-id-included w-52 h-66 rounded self-center" src="'.$bookImage.'" alt="">
                <div class="book-basic">
                    ...
                    {
                        if(isloggedIn())
                            echo '<div class="buyButton block cursor-default focus:scale-90 transition-all capitalize px-10 py-3 bg-black text-white shadow rounded-md mb-4">buy now</div>';
                    }
                    else
                        echo '<a href="auth/signin.php" class="buyButton block cursor-default focus:scale-90 transition-all capitalize px-10 py-3 bg-black text-white shadow rounded-md mb-4">buy now</a>';
