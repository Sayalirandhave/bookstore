...
<main class="p-4 w-full">
    ...
    <div class="sm:flex items-center justify-between">
        ...
        <div class="welcome my-4">
            ...
            <p class="text-lg text-gray-400 capitalize">today is thursday,4 april 2023</p>
        </div>
   ...
   ?>
    ...
    <div class="sm:m-4 p-4 bg-white rounded-lg">
        ...
        <p class="text-2xl font-bold">₹9,817</p>
 ...
 <div class="bar flex flex-col items-center justify-end h-32 relative">
    <p class="hidden price-month absolute bottom-full">₹50</p>
    <div class="w-8 h-20 bg-gray-300 rounded hover:bg-blue-600"></div>
...
<div class="bar flex flex-col items-center justify-end h-32 relative">
    <p class="hidden price-month absolute bottom-full">₹50</p>
    <div class="w-8 h-12 bg-gray-300 rounded hover:bg-blue-600"></div>
    <p class="month capitalize text-gray-400">apr</p>
</div>
<div class="bar flex flex-col items-center justify-end h-32 relative">
    <p class="hidden price-month absolute bottom-full">₹50</p>
    <div class="w-8 h-8 bg-gray-300 rounded hover:bg-blue-600"></div>
...
<div class="bar flex flex-col items-center justify-end h-32 relative">
    <p class="hidden price-month absolute bottom-full">₹990</p>
    <div class="w-8 h-28 bg-gray-300 rounded hover:bg-blue-600 hover:cursor-pointer"></div>
...
<div class="bar flex flex-col items-center justify-end h-32 relative">
    <p class="hidden price-month absolute bottom-full">₹50</p>
    <div class="w-8 h-16 bg-gray-300 rounded hover:bg-blue-600"></div>
    <p class="month capitalize text-gray-400">oct</p>
</div>
<div class="bar flex flex-col items-center justify-end h-32 relative">
    <p class="hidden price-month absolute bottom-full">₹50</p>
    <div class="w-8 h-28 bg-gray-300 rounded hover:bg-blue-600"></div>
    <p class="month capitalize text-gray-400">nov</p>
</div>
<div class="bar flex flex-col items-center justify-end h-32 relative">
    <p class="hidden price-month absolute bottom-full">₹50</p>
    <div class="w-8 h-14 bg-gray-300 rounded hover:bg-blue-600"></div>
...
<script>
  ...
  <script src="authScripts/activeDashItem.js"></script>
</html>